...
prodRed = Product.find_by(name: 'Red Bookshelf')
prodChair = Product.find_by(name: 'Electric Chair')
...
prodChair.reviews.create!({
  user_id: 1,
  description: "bad",
  rating: 1
  })

prodBed.reviews.create!({
  user_id: 1,
  description: "not bad",
  rating: 2
  })

prodHot.reviews.create!({
  user_id: 1,
  description: "great",
  rating: 5
  })
